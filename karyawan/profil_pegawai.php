...
<body class="sidebar_hidden">
	<?php
	$pesan_profil_pegawai = ''; 
	if (isset($_SESSION['pesan_profil_pegawai'])) {
		$pesan_profil_pegawai = $_SESSION['pesan_profil_pegawai'];
		unset($_SESSION['pesan_profil_pegawai']);
		echo '<script>alert("'.$pesan_profil_pegawai.'")</script>';
	}

	$idUser = $_GET['idUser'];
	$sql1 = "SELECT p.id, p.User_id, u.username, p.nama, p.alamat, u.hak_akses, u.email, p.status, p.noHp, u.tgl_regist FROM  user u JOIN pegawai p ON u.id = p.User_id WHERE u.id = $idUser";
	...
	<div id="wrapper_all">
		...
		<section id="breadcrumbs">
			<div class="container">
				<ul>
					<li><a href="pegawai.php">Karyawan</a></li>
					<li><span>Profil Karyawan</span></li>						
				</ul>
			</div>
		</section>
							...
							<div class="user_content">
								<div class="row">
									<div class="col-sm-10 col-sm-offset-2">
										<form class="form-horizontal user_form" action="profil_pegawai_sistem.php" method="POST" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-10 editable">
													<p class="form-control-static"><?php echo $row1['status']; ?></p>
													<div class="hidden_control">
														<select name="status" class="form-control">
														<?php if($row1['status'] == 'ADMIN'){ ?>
											...
											<div class="form_submit clearfix" style="display:none">
												<div class="row">
													<div class="col-sm-10 col-sm-offset-2">
														...
														<input type="hidden" class="form-control" name="idPegawai" value="<?php echo $row1['id']; ?>">
