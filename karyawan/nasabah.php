					...
					<div class="col-sm-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">Semua Nasabah</h4>
							</div>
									...
									<div class="dt-wrapper">
										<table id="dt_basic" class="table table-striped dataTable" aria-describedby="dt_basic_info">
											...
											<tbody role="alert" aria-live="polite" aria-relevant="all">
												...
												<?php 
												$no = 0;
												$result1 = mysqli_query($conn, "SELECT * FROM user u JOIN nasabah n ON u.id = n.User_id");
												...
												<tr class="odd">
													...
													<td><?php echo $allRow1['alamatPekerjaan']; ?></td>
													<td><?php echo 'E-Mail : ' . $allRow1['email'] . '<br>No Hp : ' . $allRow1['noHp'] . '<br>No Telpon : ' . $allRow1['telp']; ?></td>
													<td>
														<a class="btn btn-info" href="profil_nasabah.php?idUser=<?php echo $allRow1['User_id']; ?>">
